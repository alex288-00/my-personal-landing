...
function BurgerMenu ({isOpenBurger, onCloseBurger, onOpenForm, isOpenForm, onCloseForm}) {
    return (
      ...
      <ul className="burger__list">
          ...
          <><button className="header__button_burger" onClick={onOpenForm}>Связь со мной</button><FeedBack isOpen={isOpenForm} onClose={onCloseForm} /></>}
          <li className="footer__list"><a className="header__button_burger" href="mailto:mail@weblex.su">mail@asmirnov.su</a></li> 
          <li className="footer__list"><a className="header__button_burger" href="https://github.com/alex288-00" target="blank">Github</a></li>
          <li className="footer__list"><a className="header__button_burger" href="https://kwork.ru/user/weblex" target="blank">Kwork</a></li>
      </ul>
